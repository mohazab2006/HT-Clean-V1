      ...
      <section className="relative h-[60vh] flex items-center justify-center">
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="Professional window cleaning and power washing"
            fill
        ...
        <div className="relative z-10 container mx-auto px-4 text-center">
          ...
          <p className="text-xl md:text-2xl mb-8 text-gray-300">
            Professional window cleaning & power washing solutions
          </p>
          <div className="flex gap-4 justify-center">
            <Link 
              href="https://cal.com/your-calendar/window-cleaning"
      ...
      <section id="services" className="py-20 bg-gray-900">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {/* Window Cleaning */}
            <div className="group relative bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-8 border border-gray-700/50 transition-all duration-300 hover:scale-105 hover:shadow-[0_0_40px_rgba(59,130,246,0.3)] hover:border-blue-500/50 hover:bg-gradient-to-br hover:from-gray-700 hover:to-gray-800 cursor-pointer">
              ...
              <div className="space-y-6">
                ...
                <Link 
                  href="https://cal.com/your-calendar/window-cleaning"
                  className="block text-center bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
                  target="_blank"
                >
            ...
            <div className="group relative bg-gradient-to-br from-gray-800 to-gray-900 rounded-xl p-8 border border-gray-700/50 transition-all duration-300 hover:scale-105 hover:shadow-[0_0_40px_rgba(59,130,246,0.3)] hover:border-blue-500/50 hover:bg-gradient-to-br hover:from-gray-700 hover:to-gray-800 cursor-pointer">
              <div className="absolute -inset-0.5 bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl opacity-0 group-hover:opacity-10 transition duration-300"></div>
              <h3 className="text-2xl font-bold mb-6 text-white">Power Washing</h3>
              <div className="space-y-6">
                <div>
                ...
                <Link 
                  href="https://cal.com/your-calendar/power-washing"
                  className="block text-center bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-lg transition-colors"
                  target="_blank"
                >
